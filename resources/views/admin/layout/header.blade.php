<div class="search-header me-auto">
  ...
  <div class="search-result">
    <div class="group">
      <div class="category">Recent searchddd</div>
      <div class="list mb-4">
        <div class="item d-flex py-3"><a class="link d-flex align-items-center flex-fill">
            <div class="thumb"><img srcset="/admin/img/content/image-05@2x.jpg 2x"
                src="/admin/img/content/image-05.jpg" alt="Put your title here" />
            </div>
        ...
        <div class="item d-flex py-3"><a class="link d-flex align-items-center flex-fill">
            <div class="thumb"><img srcset="admin/img/content/image-06@2x.jpg 2x"
                src="admin/img/content/image-06.jpg" alt="Put your title here" />
            </div>
            <div class="description">
              <div class="caption">Small caption</div>
              <div class="group-title">Put your title here</div>
...
<div class="navbar">
    ...
    {{-- <div class="toggle-body">
      ...
      <div class="message-list mb-4"><a
          ...
          <div class="userpic flex-shrink-0 me-3 position-relative online"><img class="w-100"
              src="/admin/img/content/user-2.jpg" /></div>
          ...
          <div class="userpic flex-shrink-0 me-3 position-relative online"><img class="w-100"
              src="admin/img/content/user-3.jpg" /></div>
          <div class="content w-100">
            <div class="item-title mb-1 d-flex align-items-center justify-content-between">
          ...
          <div class="userpic flex-shrink-0 me-3 position-relative"><img class="w-100"
              src="/admin/img/content/user-4.jpg" /></div>
          <div class="content w-100">
            <div class="item-title mb-1 d-flex align-items-center justify-content-between">
  ...
  <div class="nav-item user-item toggle-item">
    <div class="toggle-head nav-link"><img src="/admin/img/content/user-1.jpg"></div>
    <div class="toggle-body">
