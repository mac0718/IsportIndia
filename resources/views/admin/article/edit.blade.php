                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="select select-wide category" name="category">
                                        ...
                                        <option {{ old('category',$article->category)=='match_prediction'
                                        ...
                                        <option {{ old('category',$article->category)=='fantasy' ? 'selected' : ''
                                            ...
                                            Fantasy</option>
                                        <option {{ old('category',$article->category)=='odi_wc'
                                            ? 'selected' : '' }} value="odi_wc">Odi World Cup</option>
                                        <option {{ old('category',$article->category)=='record'
                                            ? 'selected' : '' }} value="record">Record & Stats</option>
                                ...
                                <div class="col-md-12 mt-4">
                                    ...
                                    <select class="select select-wide" name="status">
                                        <option  {{old('category',$article->status)==1
                                            ?'selected' : '' }} selected value="1">Publish
                                        </option>
                                        <option  {{old('category',$article->status)==2 ? 'selected' : '' }} value="2">Save Draft
                                        </option>
                                    </select>
                                </div>
                            </div>
