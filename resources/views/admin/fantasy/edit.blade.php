        ...
        <div class="row g-0">
            <div class="col-lg-12 col-12 pe-lg-2">
                <div class="card mb-2 p-4 p-sm-5">
                    ...
                    <form action="{{ route('fantasy.update',$news->id) }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                       <div class="card-body p-0">
                            <div class="row">
                                 <div class="col-md-12 mt-4">
                                    <div class="caption d-flex align-items-center mb-3 text-reset fs-8">Select Upcoming Match
                                        <div class="info-tooltip ms-1" data-bs-toggle="tooltip"
                                            title="Optional if you dont want leave it empty">
                                    ...
                                    @enderror
                                    <select class="select select-wide" name="match_id">
                                        <option value="" selected disabled>Select Upcoming Match</option>
                                        @foreach (getMatch() as $val)
                                        <option {{ old('match_id',$news->match_id)==$val['match_id'] ? 'selected' : '' }} value="{{$val['match_id']}}">
                                            {{$val['title']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-12 mt-4">
                                    ...
                                    <select class="select select-wide" name="status">
                                        <option {{ old('status',$news->status)==1 ? 'selected' : '' }} 
                                            value="1">Publish
                                        </option>
                                        <option {{ old('status',$news->status)==2 ? 'selected' : '' }}
