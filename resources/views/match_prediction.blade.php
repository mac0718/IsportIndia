...
<script>
  ...
  function loadMoreLatest() {
    ...
    xhr.open('GET', '{{ route("loadMorePredictions") }}?offset=' + offset + '&limit=' + limit, true);
    ...
    xhr.onload = function() {
      if (xhr.status >= 200 && xhr.status < 300) {
        ...
        response.matchPredictions.forEach(function(article) {
          var articleHTML = '';
          var imgSrc = article.img ? 'https://isportindia.com/storage/app/public/' + article.img : '';
          var url = "/post-details/" + article.slug;
                ...
                <div class="row-8 row">
                    <div class="col-sm-6 col-5">
                        <a href="${url}">
                            <div class="style_postimg__ftSiV undefined block-img">
                                <span style="">
                                    <img alt="${article.alt}" src="${imgSrc}" decoding="async" data-nimg="responsive" style="..." sizes="(max-width: 767px) 120px, (max-width: 991px) 180px, (max-width: 1190px) 200px, 240px" />
                                </span>
                            </div>
                        </a>
                    </div>
                    <div class="d-flex flex-column justify-content-between col-sm-6 col-7">
                        ...
                        <div class="style_articleInfo__WqisT undefined d-flex">
                            <span class="d-flex align-items-center">
                                <span class="style_icon__Ukkjh undefined d-block">
                                    <!-- ... -->
                                </span>
                                ${formattedDate}
                            </span>
        ...
        `;
            ...
            <article id="${article.id}" class="style_article__IayJx style_articleSmall__SMJc6 undefined">
                <div class="row-8 row">
                    <div class="col-sm-3 col-5">
                        <a class="style_postimg__ftSiV undefined d-block block-img"  href="${url}">
                            <span style="">
                                <img alt="${article.alt}" src="${imgSrc}" decoding="async" data-nimg="responsive" style="..." sizes="(max-width: 767px) 120px, (max-width: 991px) 180px, (max-width: 1190px) 200px, 240px" />
                            </span>
                        </a>
                    ...
                    <div class="d-flex flex-column justify-content-between col-sm-9 col-7">
                        ...
                        <div class="style_articleInfo__WqisT d-flex">
                            <span class="d-flex align-items-center">
                                <span class="style_icon__Ukkjh d-block">
                                    <!-- ... -->
                                </span>
                                ${formattedDate}
                            </span>
        ...
        `;
            ...
            articleHTML += `
            <article class="style_article__IayJx style_articleList__HOi_f py-0">
                <h4 id="${article.id}" class="small-head mb-0">
                    <a class="d-flex align-items-center"   href="${url}">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3.66667 2H15.3333C16.25 2 17 2.75 17 3.66667V12L12 17H3.66667C2.75 17 2 16.25 2 15.3333V3.66667C2 2.75 2.75 2 3.66667 2ZM15.3333 11.1667V3.66667H3.66667V15.3333H11.1667V11.1667H15.3333ZM9.5 11.1667H5.33333V9.5H9.5V11.1667ZM5.33333 7.83333H13.6667V6.16667H5.33333V7.83333Z" fill="#757A82"></path>
                        </svg>
                        <span class="style_textTruncate__R9wLD">${article.title}</span>
                    </a>
                </h4>
            </article>
        `;
