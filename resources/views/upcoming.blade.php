...
<head>
    ...
    <meta name="og:title" content="{!! Str::limit($article->title, 40, ' ...') !!}" />

    <meta name="robots" content="Follow, Index" />
    <meta property="og:title" content="{!! Str::limit($article->title, 50, ' ...') !!}" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="{{ url()->current() }}" />
    <meta property="og:site_name" content="isportindia" />
    <meta property="og:image" content={{ getImageUrl($article->img) }} />
    <meta property="og:image:alt" content="no image" />
    <meta property="og:image:width" content="640" />
    <meta property="og:image:height" content="400" />
    <meta property="og:image" content={{ getImageUrl($article->img) }} />
    <meta property="og:image:type" content="image/jpeg" />
    <meta property="og:description" content="{!! Str::limit($article->short_description, 100, ' ...') !!}" />
                            ...
                            <article>
                                ...
                                <div class="undefined d-flex flex-wrap align-items-start mb-2 mb-md-3">
                                    <div class="style_author__Kem0w font-semi">
                                        <div class="undefined pe-2 my-1 mb-md-2 mt-md-0"><a class="text-capitalize " href="#"><span class="text-muted">By </span>{{
                                        $article->user->name
