    ...
    <div class="row">
      ...
      <section class="style_homeArticles__4e_Na" id="latestUpdateSection">
        <div class="line-title mb-2 mb-md-4 text-uppercase text-center overflow-hidden">
          <h4 class="rounded-pill position-relative d-inline-block">Record & Stats</h4>
        </div>

        @if ($record)
        @foreach($record as $lh)
        @if($lh->type=="highlighter")
        <article id="{{$lh->id}}" class="style_article__IayJx style_articleMedium__ME07j undefined">
          <div class="row-8 row">
            <div class="col-sm-6 col-5">
              <a href="{{ route('record.details',[$lh->slug]) }}">
        ...
        <article id="{{$lh->id}}" class="style_article__IayJx style_articleSmall__SMJc6 undefined">
          <div class="row-8 row">
            <div class="col-sm-3 col-5">
              <a class="style_postimg__ftSiV undefined d-block block-img" href="{{route('record.details',[$lh->slug])}}"><span style="
                              box-sizing: border-box;
                              display: block;
                              overflow: hidden;
                              width: initial;
...
<script>
  ...
  function loadMoreLatest() {
    ...
    xhr.open('GET', '{{ route("loadMoreRecords") }}?offset=' + offset + '&limit=' + limit, true);
