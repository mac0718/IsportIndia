...
<div class="common-section">
  <div class="style_homeContainer__89N3q container">
    <div class="row">
      ...
      {{-- ARTICLES 1st --}}
      <div class="Articles-data show tabs-data " id="latestUpdateSection">
        <h4 class="line-title text-uppercase text-center overflow-hidden">
          <span class="rounded-pill position-relative d-inline-block">Fantasy Preview</span>
        </h4>
        ...
        <article class="style_article__IayJx undefined" id="{{$fantasy->id}}">
          <a class="style_postimg__ftSiV d-block block-img mb-2 mb-md-3" href="{{route('fantasy.details',[$fantasy->slug])}}"><span style="
            ...
            "><span style="
              ...
              " /></span></a>
          <span class="undefined undefined mb-1 badge bg-danger"><a href="/dream11-fantasy-tips/">{!! Str::limit($fantasy->title, 30, ' ...') !!}</a></span>
          <h3 class="small-head mb-2">
            <a href="{{route('fantasy.details',[$fantasy->slug])}}">{!! Str::limit($fantasy->short_description, 50, ' ...') !!}</a>
          </h3>
  ...
  <script>
    ...
    function loadMoreLatest() {
      ...
      xhr.open('GET', '{{ route("loadMoreFantasy") }}?offset=' + offset + '&limit=' + limit, true);
        ...
        if (xhr.status >= 200 && xhr.status < 300) {
          ...
          response.fantasys.forEach(function(article) {
            ...
            if (article.type === "highlighter") {
              articleHTML += `
            <article class="style_article__IayJx undefined" id="${article.id}">
                <a class="style_postimg__ftSiV d-block block-img mb-2 mb-md-3" href="${url}"><span style="
                    box-sizing: border-box;
                    display: block;
                    overflow: hidden;
                    width: initial;
                  ...
                  "><span style="
                      ...
                      padding: 0;
                      padding-top: 62.5%;
                    "></span><img alt="${article.id}" src="${imgSrc}" decoding="async" data-nimg="responsive" style="position: absolute;
                      top: 0;
                      left: 0;
                      bottom: 0;
                      right: 0;
                    ...
                    " /></span></a>
                <span class="undefined undefined mb-1 badge bg-danger"><a href="/dream11-fantasy-tips/">${article.title}</a></span>
                <h3 class="small-head mb-2">
                  <a href="${url}">${article.short_description}</a>
                </h3>
                <div class="style_articleInfo__WqisT d-flex">
                  <span class="d-flex align-items-center"><span class="style_icon__Ukkjh d-block"><span style="
                        box-sizing: border-box;
                      ...
                      "><span style="
                        ...
                        "></span><img alt="Calender" src="/_next/static/media/calender-icon.23e624a9.svg" decoding="async" data-nimg="responsive" style="
                          ...
                          min-height: 100%;
                          max-height: 100%;
                        " /> </span></span>${formattedDate}</span><span class="d-flex align-items-center"><span class="style_icon__Ukkjh d-block"><span style="
                        box-sizing: border-box;
                        display: block;
                        overflow: hidden;
                        width: initial;
            ...
            <article id="${article.id}" class="style_article__IayJx style_articleSmall__SMJc6 undefined">
              <div class="row-8 row">
                ...
                "><span style="
                    ...
                    padding: 0;
                    padding-top: 62.5%;
                  "></span><img alt="Dindigul Dragons" src="${imgSrc}" decoding="async" data-nimg="responsive" style="
                    position: absolute;
                    top: 0;
                    left: 0;
                    bottom: 0;
