...
class FantasyController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       $input = $request->validate([
            'title' => 'required|max:255|unique:fantasies',
        ...
        $input['match_id'] = $request->match_id;
    ...
    public function edit(Fantasy $fantasy)
    {
        ...
        return view('admin.fantasy.edit', compact('news'));
    }
    ...
    public function update(Request $request, Fantasy $fantasy)
    {
        ...
        $description = $dom->saveHTML();
        $input = $request->validate([
            'title' => 'required|max:250|unique:articles,title,' . $fantasy->id,
            'description' => 'required',
            'short_description' => 'required',
            'img' => 'nullable|image',
            'status' => 'required',        
